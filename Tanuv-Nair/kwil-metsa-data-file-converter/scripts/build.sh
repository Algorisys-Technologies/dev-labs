...
# Build script for kwil-metsa-data-file-converter
# Generates binaries for a specified platform
...
BINARY_NAME="kwil-metsa-data-file-converter"
...
for platform in "${PLATFORMS[@]}"; do
    ...
    # Build the binary from the cmd/app entry point
    echo "  Building $BINARY_NAME..."
    GOOS=$GOOS GOARCH=$GOARCH go build -o "$OUTPUT_PATH" "$PROJECT_ROOT/cmd/app"
