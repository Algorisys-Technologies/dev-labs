defmodule Ignite.HSTS do
  ...
  def put_hsts_header(%Ignite.Conn{} = conn) do
    if Application.get_env(:elixir_ignite, :hsts, false) do
      max_age = Application.get_env(:elixir_ignite, :hsts_max_age, @default_max_age)
