defmodule Mix.Tasks.Ignite.Gen.Cert do
  ...
  defp generate_cert(hostname, certpath, keypath) do
    if System.find_executable("openssl") == nil do
      Mix.shell().error("Failed to generate certificate: `openssl` command not found.")
      Mix.shell().info("Please install OpenSSL and verify it is in your PATH. (On Windows, you can install it via Git Bash or scoop/winget).")
    else
